...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # layout.addWidget(self.cursorPreview)
    ...
    def update_counter_preview(self):
        ...
        layer = [
            ...
            "sidecolorR.png",          # 1
            "MinMax.png",              # 2
            "Blank1.png", "Blank1.png", "Blank1.png", "Blank1.png",  # 3-6
            os.path.relpath(os.path.join(self.pokeballIcon, "Pokeball-Icon2.png"), self.previewimages),  # 7
